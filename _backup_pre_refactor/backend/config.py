...
# ============ 数据库配置 (Phase 3: 支持 PostgreSQL) ============
DB_TYPE = os.environ.get("DB_TYPE", "sqlite").lower()
assert DB_TYPE in ("sqlite", "postgresql"), "DB_TYPE 必须是 sqlite 或 postgresql"
...
def get_database_url():
    """根据 DB_TYPE 返回 SQLAlchemy 兼容的数据库 URL"""
...
assert OLLAMA_LB_STRATEGY in ("round_robin", "least_conn", "random"), "非法负载均衡策略"
...
assert SESSION_TYPE in ("redis", "filesystem", "null"), "非法 SESSION_TYPE"
